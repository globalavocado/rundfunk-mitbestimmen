  ...
  context("authenticated", function() {
    ...
    describe("click on support button", function() {
      it("turns the heart red", function() {
        ...
        this.render(hbs`{{decision-card broadcast=broadcast}}`);
        expect(
          this.$(".decision-card-support-button i.icon.heart").hasClass("red")
        ).to.be.false;
        this.$(".decision-card-support-button").click();
        expect(
          this.$(".decision-card-support-button i.icon.heart").hasClass("red")
      ...
      it("calls respondAction and returns the broadcast, if respondAction given", function(
        done
      ) {
        ...
        this.render(
          hbs`{{decision-card broadcast=broadcast respondAction=callback}}`
        );
        this.$(".decision-card-support-button").click();
      });
